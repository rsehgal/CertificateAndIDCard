...
{\centering
{\onehalfspacing
    {\LARGE\bfseries {\color{other}{{ International Workshop on Applied Antineutrino Physics}}}}\\%\initfamily
...
of {\sub}, {\inst}, {\place},
has participated in the ``\emph{\color{phd}{International Workshop on Applied Antineutrino Physics}}''   sponsored   by  {Board of Research in Nuclear Science} and  organized  by  {Nuclear
Physics Divsion, BARC, at Anushaktinagar, Mumbai},  from
November 30$^{\text{th}}$ to December 01$^{\text{st}}$, 2017.}
...
\begin{minipage}[l]{2.8in}
 \sigskip \signature{}{Dr. L. M. Pant \\ Convener(IWAAP-2017) }
\end{minipage}
\hfill
\begin{minipage}[r]{2.8in}
\sigskip \signature{}{Dr. Vishwajeet Jha \\ Secretary(IWAAP-2017) }
\end{minipage}}
%=============================
\pagebreak
}
